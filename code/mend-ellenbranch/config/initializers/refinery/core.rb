...
Refinery::Core.configure do |config|
  ...
  # the default file system for storing resources and images
   ...
   # config.s3_access_key_id = 'AKIAJPYL4LC7TCYZEDCQ'
   # config.s3_secret_access_key = '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'
   # config.s3_bucket_name = 'Mend'
  ...
  # config.dragonfly_secret = "fa8b181936386e3c47b2e1d18640bd7de4f15a6b9f18777c"
